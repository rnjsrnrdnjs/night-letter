 ...
 */
export declare function isPrefix(prefix: string): boolean;
/**
...
export declare function is(type: IArpTableRow['type'] | 'undefined', address: string): Promise<boolean>;
